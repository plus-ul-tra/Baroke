...
void BoardManager::InitializeJokerInfoMap()
{
	...
	m_jokerInfoMap[StoneAbility::jokerEgg]			= { "jokerEgg.png",	"T_JokerEgg_Tooltip.png",				JokerType::Wild, 5, 0, 0, 1, 5, 0, 2, 1, true };
	m_jokerInfoMap[StoneAbility::jokerOstrichEgg]	= { "jokerOstrichEgg.png", "T_JokerEgg_Tooltip.png",		JokerType::Wild, 4, 0, 0, 2, 0, 0, 0, 2, true, false };
	...
	//------------------------------------------------------------------------------------------------ 우주 (set 3)
	m_jokerInfoMap[StoneAbility::jokerTeleport]		= { "jokerTeleport.png", "T_JokerTeleport_Tooltip.png",		JokerType::Space, 0, 0, 0, 0, 2, 0, 4, 2, true };
	m_jokerInfoMap[StoneAbility::jokerExplode]		= { "jokerExplode.png",	"T_JokerExplode_Tooltip.png",		JokerType::Space, 0, 0, 0, 1, 3, 0, 6, 3, true };
	...
	m_jokerInfoMap[StoneAbility::jokerBlackhole]	= { "jokerBlackhole.png", "T_JokerBlackhole_Tooltip.png",	JokerType::Space, 1, 1, 0, 5, 10, 0, 8, 3, true };
	...
	m_jokerInfoMap[StoneAbility::jokerTriunion]		= { "jokerTriunion.png", "T_JokerFusion_Tooltip.png",		JokerType::Dancheong, 0, 0, 0, 3, 0, 0, 3, 2, true, false, StoneType::White };
	m_jokerInfoMap[StoneAbility::jokerQuadunion]	= { "jokerQuadunion.png", "T_JokerFusion_Tooltip.png",		JokerType::Dancheong, 0, 0, 0, 4, 0, 0, 4, 3, true, false, StoneType::White };
	...
	m_jokerInfoMap[StoneAbility::jokerMrchan]		= { "jokerMrchan.png", "T_JokerMrchan_Tooltip.png",			JokerType::Halloween, 0, 0, 0, 0, 0, 0, 0, 3, true };

	//------------------------------------------------------------------------------------------------ 자연 (set 7)
	m_jokerInfoMap[StoneAbility::jokerShadow]		= { "jokerShadow.png", "T_JokerShadow_Tooltip.png",			JokerType::Natural, 0, 0, 0, 4, 3, 0, 4, 2, true };
