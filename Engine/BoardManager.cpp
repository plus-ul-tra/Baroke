...
void BoardManager::InitializeJokerInfoMap()
{
	...
	//------------------------------------------------------------------------------------------------ 일반 (set 1)
	m_jokerInfoMap[StoneAbility::jokerOmok]			= { "T_jokerOmok.png", "T_JokerOmok_Tooltip.png", "stonePlace.wav",			JokerType::Default, 1, 0, 0, 0, 5, 2, 6, 3, true, true, StoneType::Black };
	m_jokerInfoMap[StoneAbility::jokerSamok]		= { "T_jokerSamok.png", "T_JokerSamok_Tooltip.png", "stonePlace.wav",		JokerType::Default, 0, 0, 0, 0, 5, 0, 4, 3, false };
	m_jokerInfoMap[StoneAbility::jokerSammok]		= { "T_jokerSammok.png", "T_JokerSammok_Tooltip.png", "stonePlace.wav",		JokerType::Default, 0, 0, 0, 0, 5, 2, 3, 3, false };
	...
	m_jokerInfoMap[StoneAbility::jokerExplode]		= { "T_jokerExplode.png",	"T_JokerExplode_Tooltip.png", "jokerExplode.wav",	JokerType::Space, 1, 1, 0, 1, 3, 0, 9, 3, true };
	m_jokerInfoMap[StoneAbility::jokerMagnetic]		= { "T_jokerMagnetic.png", "T_JokerMagnetic_Tooltip.png", "jokerMagnetic.wav",	JokerType::Space, 1, 1, 0, 3, 4, 2, 7, 2, true };
	m_jokerInfoMap[StoneAbility::jokerBlackhole]	= { "T_Balckhole.png", "T_JokerBlackhole_Tooltip.png", "jokerBlackhole.wav",		JokerType::Space, 1, 1, 0, 5, 10, 0, 12, 3, true };

	//------------------------------------------------------------------------------------------------ 단청 (set 4)
	m_jokerInfoMap[StoneAbility::jokerFusion]		= { "T_jokerFusion.png", "T_JokerFusion_Tooltip.png", "stonePlace.wav",		JokerType::Dancheong, 0, 0, 0, 1, 2, 0, 7, 2, true, true, StoneType::White };
	m_jokerInfoMap[StoneAbility::jokerTriunion]		= { "T_jokerTriunion.png", "T_JokerFusion_Tooltip.png", "stonePlace.wav",	JokerType::Dancheong, 0, 0, 0, 2, 0, 0, 0, 2, true, false, StoneType::White };
	m_jokerInfoMap[StoneAbility::jokerQuadunion]	= { "T_jokerQuadunion.png", "T_JokerFusion_Tooltip.png", "stonePlace.wav",	JokerType::Dancheong, 0, 0, 0, 3, 0, 0, 0, 3, true, false, StoneType::White };

	//------------------------------------------------------------------------------------------------ 할로윈 (set 6)
	m_jokerInfoMap[StoneAbility::jokerSplit]		= { "T_jokerSplit.png", "T_JokerSplit_Tooltip.png", "jokerSplit.mp3",		JokerType::Halloween, 3, 0, 0, 20, 2, 0, 7, 2, true };
	m_jokerInfoMap[StoneAbility::jokerWaxseal]		= { "T_jokerWaxseal.png",	"T_JokerWaxseal_Tooltip.png", "jokerWaxseal.mp3",	JokerType::Halloween, 0, 0, 0, 1, 0, 0, 4, 2, true, true, StoneType::Black };
	m_jokerInfoMap[StoneAbility::jokerFlip]			= { "T_jokerFlip.png", "T_JokerFlip_Tooltip.png", "jokerFlip.wav",			JokerType::Halloween, 1, 1, 0, 0, 3, 1, 9, 2, true, true, StoneType::Black };
	m_jokerInfoMap[StoneAbility::jokerOthello]		= { "T_jokerOthello.png", "T_JokerOthello_Tooltip.png", "jokerOthello.wav",	JokerType::Halloween, 1, 0, 0, 2, 2, 4, 7, 1, true, true, StoneType::Black };
	m_jokerInfoMap[StoneAbility::jokerMrchan]		= { "T_jokerMrchan.png", "T_JokerMrchan_Tooltip.png", "jokerMrchan.wav",		JokerType::Halloween, 1, 1, 0, 0, 5, 0, 18, 3, true };
	...
	m_jokerInfoMap[StoneAbility::jokerLight]		= { "T_jokerLight.png", "T_JokerLight_Tooltip.png", "jokerLight.wav",		JokerType::Natural, 1, 1, 0, 0, 0, 0, 6, 2, true, true, StoneType::Black };
