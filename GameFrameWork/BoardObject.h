...
inline unordered_map<int, BoardType> boardTypes =
{
	...
	{2, {"Space.png",						3.0f, XMFLOAT4(0.2f, 0.9f, 0.2f, 1.0f), {effectTypes[0], effectTypes[1], effectTypes[2], effectTypes[3]}}},
	{3, {"T_Dancheong_Main_Glow.png",		3.0f, XMFLOAT4(0.9f, 0.8f, 0.6f, 1.0f), {effectTypes[0], effectTypes[1], effectTypes[2], effectTypes[3]}}},
	{4, {"T_Halloween_Main_Glow.png",		3.0f, XMFLOAT4(0.2f, 0.5f, 0.8f, 1.0f), {effectTypes[0], effectTypes[1], effectTypes[2], effectTypes[3]}}},
	{5, {"Cyberpunk.png",					3.0f, XMFLOAT4(0.8f, 0.2f, 0.2f, 1.0f), {effectTypes[0], effectTypes[1], effectTypes[2], effectTypes[3]}}}
};
